...
```{r}
plot(energyDat2016$ENERGYSTARScore, energyDat2016$PropertyGFATotal, main = "Relationship between property size and Energy score", xlab = "Size of property in square feet", ylab = "Energy star score out of 100")
...
```{r}
plot(energyDat2016$ENERGYSTARScore, energyDat2016$YearBuilt, main = "Relationship between the year built and Energy score", xlab = "Year of property construction", ylab = "Energy star score out of 100")
